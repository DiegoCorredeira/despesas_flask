...
def index():
    if request.method == 'POST':
        ...
        with app.app_context():
            nova_despesa = Despesa(descricao=descricao, categoria=categoria, data=data_br, valor=valor_formatado, status=status)
...
def adicionar_ganhos():
    if request.method == 'POST':
        ...
        with app.app_context():
            novo_ganho = Ganho(descricao=descricao, categoria=categoria, data=data_br, valor=valor_formatado, responsavel=responsavel)
